...
(function (t, e) {
  ...
  var n = 500,
    ...
    m = function (n, a) {
      ...
      var l, h;
      if (((h = T ? T(n) : n.getAttribute(r)), null !== h))
        l = /p$/.test(h)
          ? (h.slice(0, -1) / 100) * t.documentElement.clientHeight
          : +h * k;
      else {
      ...
      return (
        ...
        E && E(o, l),
        S && !a
          ? v.animateTo(l, { duration: q, easing: b })
          : g(function () {
              v.setScrollTop(l);
            }),
        !0
